    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin-left: 5px;">
            <el-row>
                ...
                <el-input size="small" style="width: 200px;" v-model="productQueryDto.name" placeholder="书名" clearable
                    @clear="handleFilterClear">
                    <el-button slot="append" @click="handleFilter" icon="el-icon-search"></el-button>

                </el-input>
                <el-input size="small" style="width: 200px;" v-model="productQueryDto.author" placeholder="作者名" clearable
                    @clear="handleFilterClear">
                    <el-button slot="append" @click="handleFilter" icon="el-icon-search"></el-button>

                </el-input>
                <el-input size="small" style="width: 200px;" v-model="productQueryDto.subject" placeholder="主题" clearable
                    @clear="handleFilterClear">
                    <el-button slot="append" @click="handleFilter" icon="el-icon-search"></el-button>
        ...
        <el-row style="margin: 0 22px;border-top: 1px solid rgb(245,245,245);">
            <el-table :stripe="true" :data="tableData">
                ...
                <el-table-column prop="name" label="书本名"></el-table-column>

                <el-table-column prop="author" width="110" label="作者"></el-table-column>

                <el-table-column prop="subject" width="110" label="主题"></el-table-column>
                ...
                <el-table-column prop="inventory" width="110" label="库存">
                    <template slot-scope="scope">
