/*
 ...
 Source Schema         : campusbook

 Target Server Type    : MySQL
 Target Server Version : 90500 (9.5.0)
 File Encoding         : 65001

 Date: 18/12/2025 10:14:35
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '商品类别表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '书籍', 1);
...
CREATE TABLE `complain`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '申诉主键id',
  `order_id` int NULL DEFAULT NULL COMMENT '卖家id',
  `picture_list` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '图片列表',
  `detail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '申诉信息描述',
  `admin_comment` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '管理员处理意见',
  `customer_complain_status` tinyint NULL DEFAULT NULL COMMENT '用户是否发起申诉',
  `admin_complain_status` tinyint NULL DEFAULT NULL COMMENT '管理员是否已经处理申诉',
  `create_time` datetime NULL DEFAULT NULL COMMENT '发起申诉时间',
  `process_time` datetime NULL DEFAULT NULL COMMENT '管理员处理时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `interaction`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '互动行为主键ID',
  `user_id` int NULL DEFAULT NULL COMMENT '用户ID',
  `product_id` int NULL DEFAULT NULL COMMENT '商品ID',
  `type` int NULL DEFAULT NULL COMMENT '行为类型（1：收藏；2：浏览；3： 想要）',
...
CREATE TABLE `message`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '消息表主键ID',
  `user_id` int NULL DEFAULT NULL COMMENT '接收者用户ID',
...
CREATE TABLE `operation_log`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '行为日志主键ID',
  `user_id` int NULL DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `orders`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `customer_refund_status` tinyint NULL DEFAULT NULL COMMENT '用户是否发起退款',
  `user_id` int NULL DEFAULT NULL COMMENT '用户ID',
  `buy_number` int NULL DEFAULT NULL COMMENT '购买数量',
  `refund_status` tinyint NULL DEFAULT NULL COMMENT '退款状态',
  `refund_time` datetime NULL DEFAULT NULL COMMENT '退款时间',
  `is_refund_confirm` tinyint NULL DEFAULT NULL COMMENT '退款是否确认',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '订单信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, '1765988094445', '3323', 4, 4.00, 1, '2025-12-18 00:15:14', '2025-12-18 00:14:54', 1, 2, 1, 1, '2025-12-18 00:15:41', 1);
...
CREATE TABLE `product`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '商品的ID，主键自增',
  ...
  `old_level` int NULL DEFAULT NULL COMMENT '新旧程度',
  `category_id` int NULL DEFAULT NULL COMMENT '所属商品分类的ID',
  ...
  `subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '关键词',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '商品信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, '1', '<p>1</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=8dd22f5img1.jpg', 9, 8, 12, 1, 1.00, 0, '2025-12-17 23:38:41', '1', '1');
INSERT INTO `product` VALUES (2, '2', '<p>2</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=8dd22f5img1.jpg', 9, 8, 12, 2, 2.00, 0, '2025-12-17 23:39:09', '2', '2');
INSERT INTO `product` VALUES (3, '3', '<p>3</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=07a5aa8img1.jpg', 9, 8, 12, 1, 3.00, 0, '2025-12-17 23:41:56', '3', '3');
INSERT INTO `product` VALUES (4, '4', '<p>4</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=07a5aa8img1.jpg', 9, 8, 12, 0, 4.00, 0, '2025-12-17 23:48:16', '4', '4');
INSERT INTO `product` VALUES (5, '5', '<p>5</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=07a5aa8img1.jpg', 9, 8, 12, 1, 5.00, 0, '2025-12-17 23:49:34', '5', '5');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin', '14e1b600b1fd579f47433b88e8d85291', '/api/book-manage-sys-api/v1.0/file/getFile?fileName=60c99f6Snipaste_2024-08-31_17-40-55.png', '1343243@qq.com', 1, 0, 0, '2024-12-04 12:53:05');
